function oplotmimas_fig13, radius, data, nsum = nsum, rebin=rebin, star=star, title=title, Tao=taosum, ANGLES=angles, PHASE=phase, uperror=uperror,downerror=downerror, scl=SCL,layout=layout,modelplot=modelplot,optional=optional,aniso=aniso, joshplot=joshplot

;Plot warper based on oplotmimas.pro, Tuned to plot Figure 13 of Sega et al 2024
  ...
  if KEYWORD_SET(title) then begin
    ...
    if keyword_set(layout) then begin
      ...
      ;graphic = plot(radius[r[0]:r[1]] -rv, taosum[r[0]:r[1]], yrange=[0,5], xtitle='Distance from resonance [km]', ytitle='Optical Depth', color='red', font_size = 14, XTICKFONT_SIZE=24, YTICKFONT_SIZE=24, Name = 'Data',overplot=1,thick=2)
