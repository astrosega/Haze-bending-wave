...
phi_copy=phi
  ...
  FOR p=0.0, n, step do begin
    ...
    if r_haze1 LT x[0] then begin
      ...
      if (r1 EQ r2) OR (r2 EQ d_nor/Sin(beff)) then begin
        optd_minus = 0
        r2=d_nor/Sin(beff)
        r1=0
      endif
  ...
  chi = goodfit2(radius, Irr/I0, r, exp(-optd), points_in_model, taosigma = Sqrt(Irr)/I0)
...
print, rv
;toc
Return, Chi_total/(498.) ;these numbers are the degrees of freedom
