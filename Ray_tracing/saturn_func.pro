...
;IDL> saturn_func([1.39, 0.0576., 367],plot=1) epsilon1 phase obs   (1.3905730     0.057039060       366.76825) if magnus2 is used (the other dataset that does substract the baclground from Irr) chi¨2 4.5189223
