...
Pro wpl77dt97, seconds, omega, thetaxs36, thetays36, phis36, deltav36, deltavk36, vkdr, omegax36, omegay36, omegaz36, w, l36, h, x0s36, y0s36, x2s36, x1s36, z1s36, z2s36, dhdot
  tic
  ...
  ;l77 represents the legth of the self-gravity wake used (77m) and dt 97 represents that the timestep os 97 seconds.
  ...
  ;thetaxs36               --> values for theta_x (roughly the angle between the long axis of the wake and the average ring plane). Defined in detail in Sega et al 2024.
  ;thetays36                --> values for theta_y (roughly the angle between the short axis of the wake and the average ring plane). Defined in detail in Sega et al 2024.
  ;phis36                   --> values for theta_z (roughly the angle between the long axis of the wake and the azimuthal). Defined in detail in Sega et al 2024.
  ;deltav36                 --> relative velocities between ring particles and wake, perpendicular to the wake surface
  ;deltavk36                --> relative vertical velocities between ring particles and wake.
  ;vkdr                   --> radial derivative of the vertical velocities within the wave
  ;omegax36, omegay36, omegaz36 --> angular veocities with respect to the principal axis of rotation.
  ;w, l36, h                --> width, length and highth of the self-gravity wake
  ;x0s36                    --> projection of the omega_x vector into the radial direction over time.
  ;y0s36                    --> projection of the omega_y vector into the radial direction over time.
  ;x2s36                    --> projection of the omega_x vector into the vertical direction over time.
  ...
  db = .004d
  startb = -6    ;normally 13, 5 for l=77
  ...
  SAVE, seconds, omega, thetaxs36, thetays36, phis36, deltav36, deltavk36, vkdr, omegax36, omegay36, omegaz36, w, l36, h, x0s36, y0s36, x2s36, x1s36, z1s36, z2s36, dhdot,filename='wpl77dt97z4.sav' ; FILENAME = 'LoverrhoH.sav' This in the last filename before first submission
  ;  SAVE, seconds, omega, thetaxs, thetays, phis, deltav, deltavk, vkdr, omegax, omegay, omegaz, w, l, h, x0s, y0s, x2s, x1s, z1s, z2s, dhdot, FILENAME = 'wakepot.0005.sav'
